...
namespace Nd.Framework.Repositories
{
        ...
        where TAggregateRoot : class, IAggregateRoot
    {
        ...
        PagedResult<TModel> FindAll<TModel>(Expression<Func<TModel, dynamic>> sortPredicate, SortOrder sortOrder, int pageNumber, int pageSize) where TModel : class;
        ...
        PagedResult<TModel> FindAll<TModel>(ISpecification<TModel> specification, Expression<Func<TModel, dynamic>> sortPredicate, SortOrder sortOrder, int pageNumber, int pageSize) where TModel : class;
        ...
        PagedResult<TModel> FindAll<TModel>(Expression<Func<TModel, dynamic>> sortPredicate, SortOrder sortOrder, int pageNumber, int pageSize, params Expression<Func<TModel, dynamic>>[] eagerLoadingProperties) where TModel : class;
        ...
        PagedResult<TModel> FindAll<TModel>(ISpecification<TModel> specification, Expression<Func<TModel, dynamic>> sortPredicate, SortOrder sortOrder, int pageNumber, int pageSize, params Expression<Func<TModel, dynamic>>[] eagerLoadingProperties) where TModel : class;
        #endregion
    }
}